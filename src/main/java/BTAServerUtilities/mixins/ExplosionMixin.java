...
public class ExplosionMixin {
	...
	private boolean preventClaimedDestruction(Set instance, Object e){
		if (worldObj.getBlockTileEntity(((ChunkPosition) e).x, ((ChunkPosition) e).y, ((ChunkPosition) e).z) instanceof TileEntityContainerInterface
			&& ((TileEntityContainerInterface) worldObj.getBlockTileEntity(((ChunkPosition) e).x, ((ChunkPosition) e).y, ((ChunkPosition) e).z)).getIsLocked()) {
			return false;
		}
		instance.add(e);
		return true;
