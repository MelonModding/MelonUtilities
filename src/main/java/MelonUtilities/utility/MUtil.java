...
public class MUtil {
	...
	public static void sendToHome(Player player, Home home) {
		teleport(home.x, home.y, home.z, player, Dimension.getDimensionList().get(home.dimID));
	}

	public static void sendToWarp(Player player, Warp warp) {
		teleport(warp.x, warp.y, warp.z, player, Dimension.getDimensionList().get(warp.dimID));
	}
