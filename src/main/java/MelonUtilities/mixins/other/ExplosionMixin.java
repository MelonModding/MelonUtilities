...
public class ExplosionMixin {
	...
	private boolean preventClaimedDestruction(Set instance, Object e){
		if (worldObj.getBlockEntity(((ChunkPosition) e).x, ((ChunkPosition) e).y, ((ChunkPosition) e).z) instanceof BlockEntityContainerInterface
			&& ((BlockEntityContainerInterface) worldObj.getBlockEntity(((ChunkPosition) e).x, ((ChunkPosition) e).y, ((ChunkPosition) e).z)).getIsLocked()) {
			return false;
		}
		instance.add(e);
		return true;
